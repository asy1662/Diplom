...
def test_russian_lang():
    ...
    with allure.step("api. Поиск по одному слову через API"):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase=гарри",
            headers=headers,
        )
...
@allure.description(
    "Тест проверяет корректный поиск книги по нескольким словам"
)
@allure.feature("READ")
@allure.severity("blocker")
@pytest.mark.positive_test
def test_russian_lang_two_words():
    with allure.step("api. Поиск по нескольким словам через API"):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase=гарри поттер",
            headers=headers,
        )
    assert resp.status_code == 200
    assert resp.headers["Content-Type"] == "application/json"
...
def test_author():
    with allure.step("api. Поиск по автору через API"):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase=Джоан Роулинг",
            headers=headers,
        )
    assert resp.status_code == 200
    assert resp.headers["Content-Type"] == "application/json"
...
def test_series():
    with allure.step("api. Поиск по серии через API"):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase=Дозоры",
            headers=headers,
        )
        assert resp.status_code == 200
        assert resp.headers["Content-Type"] == "application/json"
...
def test_genre():
    with allure.step("api. Поиск по жанру через API"):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase=Любовный роман",
            headers=headers,
        )
        assert resp.status_code == 200
        assert resp.headers["Content-Type"] == "application/json"
...
def test_eng():
    with allure.step("api. Поиск на латинице через API"):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase=Harry Potter",
            headers=headers,
        )
        assert resp.status_code == 200
        assert resp.headers["Content-Type"] == "application/json"
...
@allure.description(
    "Тест проверяет корректный поиск сопутствующих товаров на сайте"
)
@allure.feature("READ")
@allure.severity("blocker")
@pytest.mark.positive_test
def test_alt_products():
    with allure.step("api. Поиск сопутствующих товаров через API"):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase=Канцелярия",
            headers=headers,
        )
        assert resp.status_code == 200
        assert resp.headers["Content-Type"] == "application/json"
...
@allure.description(
    "Отправка запроса поиска с канцелярии с неверным методом DELETE"
)
...
def test_alt_products_del():
    with allure.step(
        "api. Отправка запроса поиска с неверным методом DELETE через API и получение ошибки 405"
    ):
...
@allure.description(
    "Тест проверяет, что сайт выдаёт ошибку при вводе знаков препинания"
)
@allure.feature("READ")
...
def test_coma():
    with allure.step(
        "api. Отправка запроса со знаками препинания через API, в ответе:Недопустимая поисковая фраза "
    ):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase=,,,",
            headers=headers,
        )
        assert resp.headers["Content-Type"] == "application/json"
...
@allure.description(
    "Тест проверяет ответ: 'Phrase должен содержать минимум 2 символа"
)
@allure.feature("READ")
@allure.severity("blocker")
@pytest.mark.negative_test
def test_empty():
    with allure.step(
        "api. Отправка пустого поиска с ответом: Phrase должен содержать минимум 2 символа через API"
    ):
        resp = requests.get(
            base_url + "/v2/search/facet-search?customer&phrase= ",
            headers=headers,
